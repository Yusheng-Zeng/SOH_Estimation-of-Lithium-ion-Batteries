...
#1读入数据
tr = pd.read_excel('d00_1.xls',header = None,index_col = None)#cell1-7 4个特征+capa
x_train = tr.iloc[0:,0:4] #左闭右开
y_train = tr.iloc[0:,4] #capa放在第五列
...
#4建立GPR模型
#https://blog.csdn.net/a_l_a_n/article/details/93888883
